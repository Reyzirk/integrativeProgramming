<!doctype html>
<?php
$lang_search = "Filter the grade list";
...
<html>
    <head>
        ...
        <title>Grade List | Demo Section</title>
                        ...
                        <table class="table table-hover table2excel" id="tableList">
                            <thead>
                                <tr class="table-active">
                                    <th class="text-center" style="cursor:default;">Grade</th>
                                    <th class="text-center" style="cursor:default;">Min Mark</th>
                                    <th class="text-center" style="cursor:default;">Max Mark</th>
                                </tr>
                            </thead>
