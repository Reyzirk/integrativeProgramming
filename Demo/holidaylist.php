<!doctype html>
<?php
$lang_search = "Filter the holiday list";
...
<html>
    <head>
        ...
        <title>Holiday List | Demo Section</title>
        ...
        <script src='JavaScript/holidays.js' type='text/javascript'></script>
    </head>
    <body>
        <div id="wrapper">
                        ...
                        <table class="table table-hover table2excel" id="tableList">
                            <thead>
                                <tr class="table-active">
                                    <th class="text-center" style="cursor:default;">Holiday</th>
                                    <th class="text-center" style="cursor:default;">Date</th>
                                </tr>
                            </thead>
