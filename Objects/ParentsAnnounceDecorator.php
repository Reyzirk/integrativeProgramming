...
class ParentsAnnounceDecorator extends AnnounceDecorator{
    ...
    public function decorate(){
        return "Good day parents! Kindly read through the announcement below. &#128522; <br/><br/>".$this->announce->getAnnounceDesc();
    }
