...
require_once str_replace("InstructorArea", "", dirname(__DIR__)) . '/Enum/WhereTypeEnum.php';
require_once str_replace("InstructorArea", "", dirname(__DIR__)) . '/Enum/JoinTypeEnum.php';