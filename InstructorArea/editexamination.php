...
include 'Function/editexamination.php';?>
<!DOCTYPE html>
<!--
============================================
...
<?php
#Page Languages
$lang_title = "Edit existing examination";
$lang_description = "Edit an existing examination.";
...
<html>
    <head>
        ...
        <script src="js/editexamination.js" type="text/javascript"></script>
    </head>
    <body>
        <div id="wrapper">
                                            ...
                                            <div class="row">
                                                <div class="col-md">
                                                    ...
                                                    <input class="bg-white form-control" disabled
                                                           id="examinationID" name="examinationID" value="<?php echo empty($storedValue["examinationID"]) ? "" : $storedValue["examinationID"]; ?>"/>
                                                </div>
