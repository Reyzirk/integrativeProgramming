...
$lang_create_btn = "Create new grade";
                        ...
                        <div id="displayList">
                            <div class="jumbotrun" id="container">
                                <div class="text-right">
                                    <button class="btn btn-info" onclick="location.href='creategrade.php'"><i class="fa-solid fa-square-plus"></i> <?php echo $lang_create_btn; ?></button>
