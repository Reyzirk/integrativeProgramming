...
<?php include 'Function/examinations.php' ?>
<!DOCTYPE html>
<!--
============================================
...
$lang_create_btn = "Create new examination";
...
<html>
    <head>
        ...
        <script src="js/examinations.js" type="text/javascript"></script>
    </head>
    <body>
        <?php callLog(); ?>
        <div id="wrapper">
                        ...
                        <div id="displayList">
                            <div class="jumbotrun" id="container">
                                <div class="text-right">
                                    <button class="btn btn-info" onclick="location.href='createexamination.php'"><i class="fa-solid fa-square-plus"></i> <?php echo $lang_create_btn; ?></button>
                                </div>
                                <br/>
                                <div class="rightSide">
