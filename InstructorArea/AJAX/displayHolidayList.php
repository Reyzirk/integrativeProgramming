...
//Sorting
if ($sortType == "Holiday"){
    usort($holidayList, $sortOrder=="ASC"?"compareNameAsc":"compareNameDesc");
}
else if ($sortType == "Date"){
    usort($holidayList, $sortOrder=="ASC"?"compareDateAsc":"compareDateDesc");
}
if (count($holidays) == 0) {
    ?>
    <tr>
