...
include 'Function/createcourseschedule.php';
?>
<!DOCTYPE html>
<!--
============================================
...
<?php
#Page Languages
$lang_title = "Create new course schedule";
$lang_description = "Create a new course schedule.";
...
<?php include 'Components/headmeta.php' ?>
        <script src="js/createcourseschedule.js" type="text/javascript"></script>
    </head>
    <body>
        <div id="wrapper">
                            ...
                            <div class="jumbotrun" id="container">
                                <form method="POST" id="form" name="form">
                                    ...
                                    <center>
                                        ...
                                        <button type="button" class="btn btn-warning" onclick="location.href = 'createcourseschedule.php'">Reset</button>
                                        <button type="button" class="btn btn-danger" onclick="location.href = 'courseschedule.php?id=<?php echo $id; ?>'">Cancel</button>
                                    </center>
                                </form>
                            </div>
                        </div>
