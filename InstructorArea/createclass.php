...
<?php include 'Function/createclass.php';require_once str_replace("InstructorArea", "", str_replace("AJAX", "", dirname(__DIR__))) . '/Database/InstructorDB.php'; ?>
<!DOCTYPE html>
<!--
============================================
...
<?php
#Page Languages
$lang_title = "Create new class";
$lang_description = "Create a new class.";
                            ...
                            <div class="jumbotrun" id="container">
                                <form method="POST" id="form" name="form">
                                    ...
                                    <center>
                                        ...
                                        <button type="button" class="btn btn-warning" onclick="location.href='createclass.php'">Reset</button>
