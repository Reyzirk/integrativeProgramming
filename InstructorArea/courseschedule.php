...
$lang_create_btn = "Create new schedule";
...
<html>
    <head>
        ...
        <script src="js/courseschedule.js" type="text/javascript"></script>
    </head>
    <body>
        <?php callLog(); ?>
        <div id="wrapper">
                        ...
                        <div id="displayList">
                            <div class="jumbotrun" id="container">
                                <div class="text-right">
                                    <button class="btn btn-info" onclick="location.href='createcourseschedule.php?id=<?php echo $id; ?>'"><i class="fa-solid fa-square-plus"></i> <?php echo $lang_create_btn; ?></button>
                                </div>
                                <br/>
                                <div class="rightSide">
