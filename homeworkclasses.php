<?php include 'Function/load.php';require_once "Database/ChildClassDB.php";include 'Function/homeworkclasses.php'; ?>
                            ...
                            <div class="class-item" style="width:100%;">
                                <div class="class-content">
                                    ...
                                    <h3 class="text-center">
                                        <a href="homeworks.php?id=<?php echo $row["ClassID"]; ?>" class="btn btn-success">View Homework</a>
                                    </h3>
