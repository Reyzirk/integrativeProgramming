<?php include 'Function/load.php';require_once "Database/ChildClassDB.php";include 'Function/timetableclasses.php'; ?>
        ...
        <div id="content">
            <div class="breadcrumbs shadow container">
                <ol class="breadcrumb" id="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Classes for timetable</li>
                </ol>
            </div>
            <div class="container">
                            ...
                            <div class="class-item" style="width:100%;">
                                <div class="class-content">
                                    ...
                                    <h3 class="text-center">
                                        <a href="timetable.php?id=<?php echo $row["ClassID"];?>" class="btn btn-success">View Timetable</a>
                                    </h3>
